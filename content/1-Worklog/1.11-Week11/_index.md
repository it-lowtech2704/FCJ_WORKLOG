...
| Tue | - **Implement Multi-Stack Architecture:** Start splitting and configuring separate Stacks (e.g., API Backend Stack, Frontend Hosting Stack). <br> - **Proceed with AI Image Processing Integration:** Combine basic CRUD functions with image processing logic (e.g., calling Rekognition API/S3 trigger) in preparation for the Update function. | 19/11/2024 | 19/11/2024 | Backend Codebase, AWS Rekognition |
